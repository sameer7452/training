...
//		numbers.stream().distinct().forEach(System.out::println);
		//distinct is intermeddiate operation
		
//		System.out.println(numbers.stream().distinct().count()); //count is a terminal operation
	
//		System.out.println(numbers.stream().filter(n->n>5).count()); //filter is an intermeddiate opeartion
		
//		numbers.stream().distinct().sorted().forEach(System.out::println); //sorted is intermeddiate
